                ...
                <div class="col-md-12 mx-0">
                    ...
                    <form id="msform"
                        ...
                        <fieldset class="form-step" data-step="5" <?= $currentStep === 5 ? 'data-active="true"' : 'style="display:none"' ?>>
                            <div class="form-card">
                                <h2 class="form-headline">
                                    <strong>Hello, <span class="name text-primary"></span>! <br class="d-md-none"><span class="long-headline">Just a few more details before viewing your options.</span></strong>
                                </h2>
                        ...
                        <fieldset class="form-step" data-step="7" <?= $currentStep === 7 ? 'data-active="true"' : 'style="display:none"' ?>>
                            <div class="form-card">
                                <h2 class="form-headline">
                                    <strong>Congratulations <span class="name text-primary"></span>!<br>
                                ...
                                <h3 class="fs-title text-primary"><b style="font-weight: 600;">Enter your information below and explore your options now.</b></h3>
            ...
            <div class="modal-body">
                <div class="text-center py-5">
                    <div class="submit-text">
                        <div class="step-title">Click button to start animation</div>
                        ...
                        <div class="substep-title">Ready to begin</div>
                        <?php /*
                            <button class="test-button" onclick="startAnimation()">Start Animation</button>
                            <div class="debug-info" id="debug">Ready to start</div>
                        */ ?>
                    </div>
                </div>
            </div>
