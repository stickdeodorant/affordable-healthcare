...
$featureTitle = 'Healthcare.gov';
$featureSubtitle = 'Learn about your options <br class="d-inline-block d-sm-none">for ' . $featureTitle;
// Use 0 or '0' for a caption value to hide the value, defaults to main otherwise
$featureCaption = [
	'default' => 'Find affordable ' . $state_abbr . ' insurance <br class="d-inline-block d-sm-none">with ' . $sitename,
	'mobile' => '',
	'filled' => '',
	'mfilled' => '',
];
		...
		<div class="container">
			<div class="row mt-5 d-flex pb-5 text-center text-lg-left">
				<div class="col-lg-7 offset-lg-1 order-md-2 scale scale-right">
					<h3 class="h1">Affordable Plans in <?php echo $state; ?> With Healthcare.gov!</h3>
					<p>With major changes to the Affordable Care Act and rising premiums across <?php echo $state; ?>, it can be difficult to navigate your current options If you are simply looking for affordable coverage that meets your budget, <?php echo $sitename; ?> can help! We provide you with eligible <?php echo $state; ?> insurance quotes FREE. Learn about your options for coverage today!</p>
				</div>
		...
		<div class="container">
			...
			<div class="row mt-5">
				<div class="col-md-6 px-sm-2 py-2 px-md-5">
					...
					<p>Looking for individual insurance plans? Learn about <?php echo $state; ?>'s health insurance options! Start comparing quotes NOW!</p>
				...
				<div class="col-md-6 px-sm-2 py-2 px-md-5">
					...
					<p>Looking for more coverage for your spouse or dependents? Learn more about your <?php echo $featureTitle; ?> coverage today, for FREE!</p>
