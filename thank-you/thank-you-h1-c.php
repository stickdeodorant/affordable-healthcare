...
<section id="typ">
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <div class="success text-center text-white mt-3 pt-4">
                        ...
                        <p>our information has been submitted. You may qualify with several different <em>a-rated insurance carriers</em>.</p>
                        
                    </div>
                    <img class="img-fluid csr" src="img/csr-man.avif" alt="Call Now">
                </div>
            </div>
        </div>
        <div class="container-fluid pt-5 mt-5">
            <div class="row pt-5 mt-5">
                <div class="col-12 text-center">
                    ...
                    <p class="mb-3 text-center">Several different groups may be contacting you with your available benefit.<br>Your information has been matched with agencies that will be reviewing your information.</p>
	...
	<style>
        ...
        h2                  { color: #2fbdaa; font-weight:600; font-size:64px; line-height:1.2; text-transform:capitalize; }
        p.sub-head          { font-size: 1.5rem; }
        .green              { color: #83bea7; }
        .checkmark          { animation: fill .4s ease-in-out .4s forwards, scale .3s ease-in-out .9s both; border-radius: 50%; box-shadow: inset 0px 0px 0px #FFF; display: inline-block; height: 56px; margin-top: -13px; stroke: #143F84; stroke-miterlimit: 10; stroke-width: 4; width: 56px; }
        ...
        @keyframes fill {
          /* 100% { box-shadow: inset 0px 0px 0px 30px #2fbdaa; } */
