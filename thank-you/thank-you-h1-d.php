...
<section id="typ">
        <div class="container-fluid bg-call-center d-flex flex-column align-items-center justify-content-center">
            <div class="row">
                <div class="col-12 text-center">
                    <div class="success text-center text-white mt-3 pt-4">
                        <h2 class="text-white">
                            <svg class="checkmark" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 52 52"><circle class="checkmark__circle" cx="26" cy="26" r="25" fill="none"/><path class="checkmark__check" fill="none" d="M14.1 27.2l7.1 7.2 16.7-16.8"/></svg>
                            <br><span>Information Received!</span>
                        </h2>
                        <p>Your information has been submitted. You may qualify with several different <em>a-rated insurance carriers</em>.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row pt-5">
                <div class="col-12 text-center">
                    <p class="mb-3 text-center">Several different groups may be contacting your with you available benefit.<br>Your information has been matched with agencies that will be reviewing your information.</p>
                    <h1 class="bolder text-center">Ready to <span class="green">enroll now?</span></h1>
                    <p class="sub-head mb-4 text-center">Call now to see what benefits you may be&nbsp;eligible&nbsp;for.</p>
                    <a class="call-btn text-center" href="tel:<?php echo ($_GET['type'] == 'medicare') ? $phonemin['typ'] : $phonemin['typ']; ?>" onclick="ga('send', 'event', 'Call Buttons', 'Click', '<?php echo ($_GET['type'] == 'medicare') ? 'medicare' : 'healthcare'; ?>', 'main');"><span>Call Now</span><br>
                        ...
                        </svg>&ensp;<?php echo ($_GET['type'] == 'medicare') ? $phone['typ'] : $phone['typ']; ?>
                    </a>
                </div>
            </div>
        </div>
	...
	<style>
        ...
        .bg-call-center     { background: transparent url(img/hero-call-center1.jpg) no-repeat scroll 50% 11%; background-size: cover; min-height: 300px; }
        .bg-blue            { background: #143F84; }
        .logo               { max-width: 240px; }
        .success            { overflow: hidden; text-shadow: 3px 3px 5px rgb(0 0 0 / 0.7); }
        h1                  { color: #143F84; font-weight:800; font-size: 45px; line-height: 1.3; text-transform: uppercase; }
        h2                  { color: #7AC142; font-weight:600; font-size:40px; line-height:1.2; text-transform:capitalize; }
        p.sub-head          { font-size: 1.5rem; }
        .green              { color: #83bea7; }
        .checkmark          { animation: fill .4s ease-in-out .4s forwards, scale .3s ease-in-out .9s both; border-radius: 50%; box-shadow: inset 0px 0px 0px #FFF; display: inline-block; height: 56px; margin-top: -13px; stroke: #143F84; stroke-miterlimit: 10; stroke-width: 4; width: 56px; filter: drop-shadow(3px 3px 5px rgb(0 0 0 / 0.7)); }
        .checkmark__circle  { animation: stroke 0.6s cubic-bezier(0.65, 0, 0.45, 1) forwards; fill: none; stroke-dasharray: 166; stroke-dashoffset: 166; stroke-width: 4; stroke-miterlimit: 10; stroke: #FFF; }
        ...
        .call-btn           { background-color: #FF6600; border: 1px solid #fff; border-radius: 100px; color: white; display: inline-block; font-size: 24px; font-weight: 600; line-height: 1.2; margin-top: 10px; max-width: 100%; padding: 5px 40px 20px; position: relative; text-decoration: none; width: 340px; }
