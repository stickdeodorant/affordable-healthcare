						...
						<div class="col-lg-8 col-xl-7 py-2 py-md-0 text-center text-lg-right d-none d-md-flex justify-content-end align-items-center">
							...
							<div class="d-inline-block">
								<div class="d-inline" style="margin-bottom: 15px;">
									<svg xmlns="http://www.w3.org/2000/svg" class="icon-phone d-inline-block" style="margin-bottom:-12px;" fill="#67cdcb" width="40px" height="40px">
									...
									<a class="d-inline text-primary" style="color: #67cdcb !important;font-size: 29px;font-weight:bold;line-height: 1;" href="tel:<?=$phonemin['agent']?>"><?=$phone['agent']?></a>
								</div>
							</div>
						</div>
					<?php } ?>
