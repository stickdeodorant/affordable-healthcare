...
$featureTitle = 'Personal Insurance';
$featureSubtitle = 'Looking for Personal <br class="d-inline-block d-sm-none">Insurance in ' . $state . '?';
// Use 0 or '0' for a caption value to hide the value, defaults to main otherwise
$featureCaption = [
	'default' =>  $sitename . ' helps to make <br class="d-inline-block d-sm-none">the search fast and easy!',
	'mobile' => '',
	'filled' => '',
	'mfilled' => '',
];
		...
		<div class="container">
			<div class="row mt-5 d-flex pb-5 text-center text-lg-left">
				<div class="col-lg-7 offset-lg-1 order-md-2 scale scale-right">
					<h3 class="h1">Searching For <?php echo $featureTitle; ?> Made Easy!</h3>
