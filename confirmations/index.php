...
<div class="container py-5 my-5">
 ...
 <form method="post" action="../get-quotes/inc/download_confirmation.php" class="text-center">
  ...
  <table class="table table-striped table-hover mt-5">
    ...
    <?php 
     $query = "SELECT * FROM leads ORDER BY id DESC LIMIT 1000";
     ...
     while($row = mysqli_fetch_array($result)){
      ...
      $error = $row['error'];
      $user_arr[] = array($id,$email,$ipaddress,$timestamp,$error);
   ?>
    <tbody>
      <tr>
        ...
        <td><?php echo htmlspecialchars((string)$error, ENT_QUOTES, 'UTF-8'); ?></td>
      </tr>
    </tbody>
   <?php
    }
