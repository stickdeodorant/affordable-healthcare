...
$featureTitle = 'Open Enrollment';
$featureSubtitle = 'Plan For Your Next <br class="d-inline-block d-sm-none">' . $featureTitle . '!';
// Use 0 or '0' for a caption value to hide the value, defaults to main otherwise
$featureCaption = [
	'default' => 'Learn more about your '.$_SESSION['state'].' health insurance <br class="d-inline-block d-sm-none">options today with '  . $featureTitle . '!',
	'mobile' => '',
	'filled' => '',
	'mfilled' => '',
];
		...
		<div class="container">
			<div class="row mt-5 d-flex pb-5 text-center text-lg-left">
				<div class="col-lg-7 offset-lg-1 order-md-2 scale scale-right">
					<h3 class="h1">Prepare For Your Next Open Enrollment!</h3>
					<p>Looking to get insured or change your current <?php echo $state; ?> healthcare plan? It is important to know when open enrollment is for your obtaining new coverage. Open enrollment is the time of year you are able to enroll for health insurance. As of <?php echo date("Y"); ?>, individual market plans have open enrollment from November 1st through December 15th. We know these dates can put you on a tight deadline to get the coverage you need. That is why we provide fast and comprehensive quotes to find you the right coverage at the right price.</p>
				</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 text-center">
						...
						<p>Looking to get more information on your results? At <?php echo $sitename; ?>, we have a team of dedicated professional to help you choose a <?php echo $state_abbr; ?> plan that best fits your needs. Call for a FREE consultation regarding your options and compare your plans TODAY!</p>
		...
		<div class="container">
			...
			<div class="row mt-5">
				<div class="col-md-6 px-sm-2 py-2 px-md-5">
					...
					<p>Looking for new individual health insurance? Prepare for your next open enrollment! Compare <?php echo $state; ?> healthcare plans, TODAY!</p>
				...
				<div class="col-md-6 px-sm-2 py-2 px-md-5">
					...
					<p>Does your current healthcare plan not provide enough coverage for your spouse or dependents? Learn more about your options, try today for FREE!</p>
