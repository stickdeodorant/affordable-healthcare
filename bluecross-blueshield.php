...
$featureTitle = 'BlueCross BlueShield';
$featureSubtitle = 'Looking to switch to <br class="d-inline-block d-sm-none">' . $featureTitle . '?';
// Use 0 or '0' for a caption value to hide the value, defaults to main otherwise
$featureCaption = [
	'default' => 'Find the best coverage in <br class="d-inline-block d-sm-none">' . $state . ' with ' . $featureTitle,
	'mobile' => '',
	'filled' => '',
	'mfilled' => '',
];
		...
		<div class="container">
			<div class="row mt-5 d-flex pb-5 text-center text-lg-left">
				<div class="col-lg-7 offset-lg-1 order-md-2 scale scale-right">
					<h3 class="h1">Start Saving on Your Health Insurance Today!</h3>
					<p>If you lose the health insurance you had with your previous employer, you may be eligible for BlueCross BlueShield coverage. This coverage allows you to keep your current coverage, and may also qualify you for a special enrollment period. However, your premiums may increase as a result. At <?php echo $sitename; ?>, we help make the search for finding <?php echo $state; ?> medical insurance fast and easy. Compare thousands of insurance quotes for FREE to find a plan that offers great coverage within your budget!</p>
				</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 text-center">
						...
						<p>Looking to get more information on your results? At <?php echo $sitename; ?>, we have a team of dedicated professionals to help you choose a plan that best fits your needs. Call for a FREE consultation regarding your options and compare your plans with the help of our expert staff.</p>
...
width: calc(32px + 12vw); max-width: 50%; transform: scaleX(-1); z-index: 2;" alt="cartoon girl picking fruit from tree">
	...
	<section id="beforeafter" class="container-fluid">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<h3 class="h1">Advantages of <br class="d-inline-block d-md-none"><?php echo $featureTitle; ?></h3>
				</div>
			</div>
			<div class="row mt-5">
				<div class="col-md-6 px-sm-2 py-2 px-md-5">
					<h3 class="mb-3 h2">Individual<span class="d-inline-block d-md-none">&nbsp;Plans</span></h3>
					<p>Looking for a new individual health plan? Your next healthcare plan is just a few clicks away! Just fill out a few details to get signed up for your next plan, TODAY!</p>
				...
				<div class="col-md-6 px-sm-2 py-2 px-md-5">
					...
					<p>Does your current insurance plan not provide enough coverage for your spouse or dependents? Learn more about your <?php echo $featureTitle; ?> options today, for FREE!</p>
