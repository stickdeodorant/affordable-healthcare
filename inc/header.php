...
<head>
	...
	<?php /* SEO tags: emitted only when a page (e.g. CMS) supplies them, so static pages are unchanged. */ ?>
	...
	<?php endif; ?>
	<?php if (!empty($metaDescription) || !empty($ogImage) || !empty($canonical)): ?>
	<meta property="og:type" content="website">
	<meta property="og:title" content="<?= htmlspecialchars(!empty($title) ? $title : $sitename, ENT_QUOTES, 'UTF-8') ?>">
	<?php if (!empty($canonical)): ?>
...
<body data-theme="<?= htmlspecialchars($activeTheme, ENT_QUOTES, 'UTF-8') ?>" <?= function_exists('ah_experiment_body_attrs') ? ah_experiment_body_attrs() : '' ?> style="<?= htmlspecialchars($themeInlineStyle, ENT_QUOTES, 'UTF-8') ?>">
