...
if (function_exists('ah_experiment')) {
	$ahHeadlineVariants = [
		'ppo' => '<span class="text-secondary">Find a PPO</span> Plan!',
		'hmo' => '<span class="text-secondary">Find an HMO</span> Plan!',
		'fast_quotes' => '<span class="text-secondary">Get Quotes</span> in Under 30&nbsp;Seconds!',
	...
	$ahCv = ah_experiment('hero_cta');
	if (isset($ahCtaVariants[$ahCv])) { $_subtitle = $ahCtaVariants[$ahCv]; }
}
	...
	<div class="container h-100">
		<div class="row ah-hero-row align-items-end">
			...
			<div class="col-12 col-lg-6 ah-hero-copy d-flex flex-column justify-content-center pt-4 pt-lg-0 pb-3 pb-lg-5">
				...
				<?php if (function_exists('ah_experiment')) {
					$ahTimingText = ['s10' => 'In as little as 10 seconds', 's20' => 'In as little as 20 seconds', 's30' => 'In as little as 30&nbsp;seconds'];
					$ahTiming = ah_experiment('timing_claim');
					if (isset($ahTimingText[$ahTiming])) {
						echo '<p class="ah-hero-timing mb-2 small font-weight-bold">' . $ahTimingText[$ahTiming] . '</p>';
					}
					if (ah_experiment('savings_msg') === 'on') {
						echo '<p class="ah-hero-savings mb-2 small">20 seconds could save you hundreds on your monthly premium.</p>';
					}
				} ?>
