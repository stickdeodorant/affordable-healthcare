<nav class="primary-nav">
  ...
  <div style="padding: 5px 20px; font-size: 12px; text-align: center; background: #d2d2d285; margin-bottom: 5px;font-weight:normal;text-transform:uppercase;" class="disc-aff">This is a marketing website and is not affiliated or endorsed by any state, government or federal agency.</div>
...
<div id="banner" style="display: block; position: relative; margin: 0 0 -1px; padding: 10px 15px; background: #124085; font-family: Montserrat,Helvetica,Arial,sans-serif; color: #fff; text-align: center; font-size: 18px;">
  <span>Health Plans Available - <span style="font-weight: 600; color: #fff;">Shop&nbsp;Now!</span></span>
</div>