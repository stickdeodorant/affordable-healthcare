...
try {
    ...
    $fromEmail = env('MAILTRAP_FROM_EMAIL', 'no-reply@healthcare-insurance.com');
    $fromName = env('MAILTRAP_FROM_NAME', 'Healthcare Insurance') . ' - Lead Analytics';
...
function buildEmailHTML($startDate, $endDate, $summary, $successRate, $dailyData, $topStates) {
    ...
    $html .= '
            ...
            <div class="footer">
                ...
                <p>© ' . date('Y') . ' Healthcare Insurance. All rights reserved.</p>
            </div>
        </div>
    </body>
    </html>';
