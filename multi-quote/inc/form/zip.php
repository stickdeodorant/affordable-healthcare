...
<form id="msform" aria-step="<?=$currentStep?>" action="./?step<?=$nextStep?>" method="get">
  ...
  <fieldset>
      <div class="form-card text-center">
          ...
          <input id="zip" name="zip" type="tel" class="form-control" placeholder="12345" autocomplete="postal-code" required <?php if(isset($_GET['zip'])) { echo 'value="'.$_GET['zip'].'"'; }?> tabindex="1">
