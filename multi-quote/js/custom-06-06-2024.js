$(document).ready(function(){
  ...
  */
  ...
  function ajaxInsertBadEmail() {
    $.ajax({
      type: 'POST',
      url: 'https://healthcare-insurance.com/get-quotes/inc/insert_bademail.php',
  ...
  function flexPostback(response) {
    ...
    $.ajax({
      url: 'https://healthcare-insurance.com/fc/inc/postback-flex.php',
      type: "POST",
      data: {
      ...
      const interval = setInterval(function() {
        ...
        if (intervalsPassed === totalIntervals) {
          ...
          setTimeout(function() {
            ...
            $.ajax({
              url: 'https://healthcare-insurance.com/get-quotes/form-processing.php',
              type: "POST",
